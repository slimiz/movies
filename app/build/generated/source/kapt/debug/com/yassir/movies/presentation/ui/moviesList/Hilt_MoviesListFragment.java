 ...
 */
public abstract class Hilt_MoviesListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MoviesListFragment() {
    super();
  }

  Hilt_MoviesListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MoviesListFragment_GeneratedInjector) this.generatedComponent()).injectMoviesListFragment(UnsafeCasts.<MoviesListFragment>unsafeCast(this));
    }
  }
