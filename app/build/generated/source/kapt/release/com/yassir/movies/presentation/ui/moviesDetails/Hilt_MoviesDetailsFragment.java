 ...
 */
public abstract class Hilt_MoviesDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MoviesDetailsFragment() {
    super();
  }

  Hilt_MoviesDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MoviesDetailsFragment_GeneratedInjector) this.generatedComponent()).injectMoviesDetailsFragment(UnsafeCasts.<MoviesDetailsFragment>unsafeCast(this));
    }
  }
