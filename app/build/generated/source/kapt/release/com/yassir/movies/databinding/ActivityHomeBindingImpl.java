...
public class ActivityHomeBindingImpl extends ActivityHomeBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"nav_header_toolbar"},
            new int[] {1},
            new int[] {com.yassir.movies.R.layout.nav_header_toolbar});
    ...
    private ActivityHomeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.yassir.movies.databinding.NavHeaderToolbarBinding) bindings[1]
            );
    ...
    public boolean hasPendingBindings() {
        ...
        if (navToolbar.hasPendingBindings()) {
            return true;
        }
        return false;
    }
    ...
    public void setLifecycleOwner(@Nullable androidx.lifecycle.LifecycleOwner lifecycleOwner) {
        ...
        navToolbar.setLifecycleOwner(lifecycleOwner);
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeNavToolbar((com.yassir.movies.databinding.NavHeaderToolbarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeNavToolbar(com.yassir.movies.databinding.NavHeaderToolbarBinding NavToolbar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
